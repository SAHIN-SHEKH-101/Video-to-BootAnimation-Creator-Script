#!/bin/bash
# Bootanimation creator script by github.com/sahin-shekh-101
# Telegram @sahinshekh101
...
echo -e "${WHITE}                 by  sahin shekh              ${NC}"
echo -e "${BRIGHT_CYAN}========================================${NC}"
sleep 2
install_package() {
  local package="$1"
...
# https://github.com/sahin-shekh-101
# sahinshekh101.t.me
...
<body>
    <div class="window">
        ...
        <div class="icons">
            <div class="icon" onclick="openLink('https://github.com/sahin-shekh-101/Video-to-BootAnimation-Creator-Script')">GitHub Page</div>
            <div class="icon" onclick="openLink('https://sahinshekh101.t.me')">Telegram</div>
        </div>
...
version=2
versionCode=30
author=sahinshekh101.t.me | github.com/sahinshekh101
EOF
#If written
